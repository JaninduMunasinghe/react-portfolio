    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="footer--copyright">
          ...
          <h4 className="footer--copyright--name">
            Janindu Munasinghe. All Rights Reserved
          </h4>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/janindu.munasinghe"
            ...
            <li>
              <a
                href="https://www.instagram.com/janindumunasinghe/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer">
                <svg
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/janindu-munasinghe-a86b64215/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer">
                <svg
